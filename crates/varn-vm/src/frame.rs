...
pub fn build_jit_helpers() -> varn_jit::JitHelpers {
    ...
    varn_jit::JitHelpers {
        ...
        str_char_code_at: ctx::jit_str_char_code_at as usize,
        str_char_code_at_fast: ctx::jit_str_char_code_at_fast as usize,
        str_substring_intrinsic: ctx::jit_str_substring_intrinsic as usize,
        str_slice_intrinsic: ctx::jit_str_slice_intrinsic as usize,
