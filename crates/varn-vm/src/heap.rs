...
impl HeapInner {
    ...
    pub fn str_val(&self, nv: VmValue) -> Option<RuntimeString> {
        ...
        if let Some(HeapObj::Str(s)) = self.get(nv.as_heap_idx()) {
            return Some(s.clone());
        }
        None
    }
    ...
    pub fn is_string(&self, nv: VmValue) -> bool {
        ...
        if nv.is_heap() {
            return matches!(self.get(nv.as_heap_idx()), Some(HeapObj::Str(_)));
        }
        false
    }
    ...
    pub fn str_repr(&self, nv: VmValue) -> String {
        ...
        if nv.is_heap() {
            return match self.get(nv.as_heap_idx()) {
    ...
    pub fn compact_interners(&mut self) {
        self.string_interner.retain(|_, &mut idx| {
            self.objects
                .get(idx as usize)
                .map(|o| o.is_some())
                .unwrap_or(false)
        ...
        self.symbol_interner.retain(|_, &mut idx| {
            self.objects
                .get(idx as usize)
                .map(|o| o.is_some())
                .unwrap_or(false)
        ...
        self.char_interner.retain(|_, &mut idx| {
            self.objects
                .get(idx as usize)
                .map(|o| o.is_some())
                .unwrap_or(false)
        ...
        self.bigint_interner.retain(|_, &mut idx| {
            self.objects
                .get(idx as usize)
                .map(|o| o.is_some())
                .unwrap_or(false)
        ...
        self.decimal_interner.retain(|_, &mut idx| {
            self.objects
                .get(idx as usize)
                .map(|o| o.is_some())
                .unwrap_or(false)
        ...
        self.array_interner.retain(|_, &mut idx| {
            self.objects
                .get(idx as usize)
                .map(|o| o.is_some())
                .unwrap_or(false)
        ...
        self.object_interner.retain(|_, &mut idx| {
            self.objects
                .get(idx as usize)
                .map(|o| o.is_some())
                .unwrap_or(false)
        ...
        self.map_interner.retain(|_, &mut idx| {
            self.objects
                .get(idx as usize)
                .map(|o| o.is_some())
                .unwrap_or(false)
        ...
        self.set_interner.retain(|_, &mut idx| {
            self.objects
                .get(idx as usize)
                .map(|o| o.is_some())
                .unwrap_or(false)
...
impl NativeCtx for Heap {
    ...
    fn is_array(&self, v: VmValue) -> bool {
        v.is_heap() && matches!(self.get(v.as_heap_idx()), Some(HeapObj::Array(_)))
    }
    ...
    fn array_len(&self, arr: VmValue) -> usize {
        if arr.is_heap() {
            if let Some(HeapObj::Array(a)) = self.get(arr.as_heap_idx()) {
                return a.borrow().len();
            }
        }
        0
