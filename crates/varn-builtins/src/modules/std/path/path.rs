...
varn_contract! {
    ...
    impl PathRuntime {
        fn pathNormalize(_ctx: &mut dyn NativeCtx, path: &str) -> String {
        ...
        fn pathDirname(_ctx: &mut dyn NativeCtx, path: &str) -> String {
        ...
        fn pathBasename(_ctx: &mut dyn NativeCtx, path: &str) -> String {
            std::path::Path::new(path)
                .file_name()
